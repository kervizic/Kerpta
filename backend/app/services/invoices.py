    ...
    result = await db.execute(
        text(f"""
            SELECT i.id::text, i.number, i.proforma_number,
                   ...
                   i.quote_id::text,                    i.contract_id::text, i.execution_document_id::text,
    ...
    await db.execute(
        text("""
            INSERT INTO invoices (
                ...
                proforma_number,
                quote_id, contract_id, execution_document_id,
                is_situation, situation_number,
        ...
        """),
        {
            ...
            "execution_document_id": getattr(data, "execution_document_id", None),
            "is_situation": getattr(data, "is_situation", False),
            "situation_number": getattr(data, "situation_number", None),
