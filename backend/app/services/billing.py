...
_DEFAULT_BORDERS_MODERNE = {
    ...
    "th_bg": "",
    "th_border_color": "#e0e0e0",
    "th_border_width": 1,
    "td_border_color": "#e0e0e0",
    "td_border_width": 0.5,
    "td_last_border": 0,
    "zebra_color": "",
    "zebra_enabled": 0,
    "totals_ht_border_color": "#e0e0e0",
    "totals_ht_border_width": 1,
    "totals_mid_border_color": "#e0e0e0",
    "totals_mid_border_width": 0.5,
    "totals_ttc_border_color": "#e0e0e0",
...
DEFAULT_DOCUMENT_STYLING = {
    ...
    "column_labels": {
        ...
        "date_credit_note": "Date de l'avoir",
        "due_date": "Date d'échéance",
        "customer_reference": "Référence",
        "purchase_order_number": "N° commande",
