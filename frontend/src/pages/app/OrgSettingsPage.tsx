    ...
    <div className="flex-1 overflow-y-auto">
      <div className="max-w-2xl mx-auto px-6 py-8 space-y-8">
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-5 space-y-4">
          ...
          {showLegalHint && (
            <div className="text-xs text-blue-700 bg-blue-50 border border-blue-200 rounded-lg px-3 py-2.5 space-y-1.5">
              <p className="font-medium text-blue-800">Mode auto / manuel par champ</p>
              <p>
