...
function CodeBlock({ code }: { code: string }) {
  ...
  return (
    <div className="relative mt-3 rounded-xl bg-slate-900 border border-white/5 overflow-hidden group">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <a
              ...
              className="flex items-center gap-3 rounded-2xl bg-white/[0.02] border border-white/5 p-6 hover:border-white/10 hover:bg-white/[0.04] transition-all group"
            >
              <span className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center shrink-0 group-hover:bg-white/10 transition-colors">
                <Github className="w-5 h-5 text-white" />
              </span>
              <div>
                <p className="text-sm font-semibold text-white">kervizic/kerpta</p>
                <p className="text-xs text-slate-500">Voir le code source</p>
              </div>
              <svg
                className="w-4 h-4 text-slate-600 ml-auto group-hover:text-slate-400 transition-colors"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={2}
